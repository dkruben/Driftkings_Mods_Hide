...
class ConfigInterface(SimpleConfigInterface):
    ...
    def load(self):
        ...
        g_guiFlash.createComponent(self.ID + '_1bg', COMPONENT_TYPE.IMAGE, {'x': 74, 'y': 51, 'image': '../HangarBoosterViewer/bg/0.png'}, False, True)
        g_guiFlash.createComponent(self.ID + '_2icons', COMPONENT_TYPE.LABEL, {'x': 85, 'y': 28, 'text': ''}, False, True)
        g_guiFlash.createComponent(self.ID + '_3timer', COMPONENT_TYPE.LABEL, {'x': 120, 'y': 69, 'shadow': {'alpha': 75, 'blur': 3, 'color': '0x0000CD', 'strength': 1}, 'text': ''}, False, True)
    ...
    @staticmethod
    def reserveFromIndex(index, reserves):
...
@override(LobbyHeaderMeta, 'as_setBoosterDataS')
def as_setBoosterDataS(base, self, data, *args, **kwargs):
    try:
        ...
        if data['hasActiveBooster']:
            ...
            data['boosterText'] = ''
        elif data['hasAvailableBoosters'] and not data['hasActiveBooster'] and config.data['hideAvailableBooster']:
            data['boosterIcon'] = BOOSTER_ICON_EMPTY
            data['boosterBg'] = BOOSTER_ICON_EMPTY
            data['boosterText'] = ''
    finally:
