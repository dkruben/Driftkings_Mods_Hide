...
LINKAGES = {
    GUN_MARKER_VIEW_CONSTANTS.DEBUG_SPG_GUN_MARKER_NAME: GUN_MARKER_VIEW_CONSTANTS.GUN_MARKER_SPG_LINKAGE,
    GUN_MARKER_VIEW_CONSTANTS.DEBUG_ARCADE_GUN_MARKER_NAME: GUN_MARKER_VIEW_CONSTANTS.GUN_MARKER_LINKAGE,
    GUN_MARKER_VIEW_CONSTANTS.DEBUG_SNIPER_GUN_MARKER_NAME: GUN_MARKER_VIEW_CONSTANTS.GUN_MARKER_LINKAGE,
    GUN_MARKER_VIEW_CONSTANTS.DEBUG_DUAL_GUN_ARCADE_MARKER_NAME: GUN_MARKER_VIEW_CONSTANTS.DUAL_GUN_ARCADE_MARKER_LINKAGE,
    GUN_MARKER_VIEW_CONSTANTS.DEBUG_DUAL_GUN_SNIPER_MARKER_NAME: GUN_MARKER_VIEW_CONSTANTS.DUAL_GUN_SNIPER_MARKER_LINKAGE
}
