...
from DriftkingsCore import SimpleConfigInterface, Analytics, override, callback, getPlayer, sendChatMessage, check_names_list, calculate_version
...
class ConfigInterface(SimpleConfigInterface):
    ...
    def init(self):
        ...
        self.data = {
            ...
            'spottedMessage': True,
            'helpMessage': False,
            'defaultIconName': check_names_list('gui/maps/icons/SixthSense/'),
