...
from DriftkingsCore import find_attr, override


@override(PreBattleTimer)
...
@override(BattleStatisticsDataController)
...
@override(QuestProgressController)
