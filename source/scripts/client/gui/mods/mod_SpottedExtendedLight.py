...
class ConfigInterface(DriftkingsConfigInterface):
    ...
    def init(self):
        ...
        self.i18n = {
            ...
            'UI_setting_AssistRadio_text': 'Radio assist message format:',
            ...
            'UI_setting_AssistTrack_text': 'Track assist message format:',
            ...
            'UI_setting_AssistStun_text': 'Stun assist message format:',
