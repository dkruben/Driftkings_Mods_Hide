...
for /F "tokens=*" %%A in (build_data\debug_targets.txt) do ("C:\Program Files\Beyond Compare 5\BCompare.exe" build\wotmods\ "%%A\mods\%ver%\" /solo)

if exist "res\sound_bank_wwise\SixthSense\GeneratedSoundBanks\Windows\driftkings_sixthsense.bnk" ("C:\Program Files\7-Zip\7z.exe" a -tzip "res\audioww\driftkings_sixthsense.wotmod" "res\audioww\driftkings_sixthsense.bnk")
