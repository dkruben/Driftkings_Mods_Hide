package driftkings.hangar
{
	...
	{
		private var creditCalc:TextExt;
		private var config:Object;

		public function CreditCalculatorUI()
		{
			super();
		...
		public function as_startUpdateLobby(settings:Object):void
		{
			...
			if (settings.enabled)
			{
				...
				this.creditCalc = new TextExt(settings.lobbyPos.x, settings.lobbyPos.y, TextFieldAutoSize.CENTER, this);
			}
		}
