package
{
    ...
    public dynamic class NationTreeNodeSkinned extends NationTreeNode
    {
        ...
        public function NationTreeNodeSkinned()
        {
            ...
            super();
            // Call this method after super() to ensure parent initialization is complete
        ...
        {
            // Add null check before accessing typeAndLevel
        ...
        internal function __setProp_handler(frame:Object) : *
        {
            var _frame:int = int(currentFrame);
            if(this.__lastFrameProp == _frame)
            {
                return;
            }
            this.__lastFrameProp = _frame;
            this.__setProp_button_NationTreeNodeSkinned_button_0(_frame);
            this.__setProp_button_NationTreeNodeSkinned_button_81(_frame);
            this.__setProp_button_NationTreeNodeSkinned_button_161(_frame);
            this.__setProp_button_NationTreeNodeSkinned_button_361(_frame);
        }
