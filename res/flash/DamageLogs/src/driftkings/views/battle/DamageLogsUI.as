package driftkings.views.battle
{
	...
	{
		private var top_log_in_center:Boolean = true;
		...
		{
			this.top_log_in_center = settings.inCenter;
			this.x = !this.top_log_in_center ? 0 : Math.ceil(App.appWidth >> 1);
		...
		{
			if (this.top_log && this.top_log_in_center)
			{
